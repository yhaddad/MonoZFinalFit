...
void setYacineStyle(){
  ...
  YacineStyle->SetFrameLineWidth(2);   // default : 2
  //
  //// For Hito
  ...
  YacineStyle->SetHatchesSpacing(0.8); // to define the spacing between hatches.
  YacineStyle->SetHatchesLineWidth(1); // to define the hatches line width.
